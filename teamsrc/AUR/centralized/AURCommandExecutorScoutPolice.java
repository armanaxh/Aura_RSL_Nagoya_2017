...
public class AURCommandExecutorScoutPolice extends CommandExecutor<CommandScout> 
{
    public AURCommandExecutorScoutPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) 
    {
        super(ai, wi, si, moduleManager, developData);
    }

    @Override
    public CommandExecutor<CommandScout> setCommand(CommandScout command) {return this;}
