...
public class AURCommandExecutorScout extends CommandExecutor<CommandScout> 
{

    public AURCommandExecutorScout(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) 
    {
    ...
    @Override
    public CommandExecutor setCommand(CommandScout command) {return this;}
